...
@SuppressWarnings({"all", "warnings", "unchecked", "unused", "cast","error"})
public class GramaticaSintagmaticaLexer extends Lexer {
	...
	public GramaticaSintagmaticaLexer(CharStream input) {
		super(input);
